...
/**
 * Object3D_two 컴포넌트 - 타원형 패턴 3D 오브젝트
...
const Object3D_two = () => {
  ...
  useEffect(() => {
    ...
    // ===== 캔버스 크기 설정 =====
    const canvasWidth = (29.04 * window.innerWidth) / 100;
    const canvasHeight = (27.47 * window.innerWidth) / 100;
    ...
    scene.add(pivot);
    pivot.position.set(-210, 200, 0);
    pivot.scale.set(3, 3, 3);

    const loader = new SVGLoader();
    loader.load("/objects/object02.svg", (data) => {
    ...
    // ===== 윈도우 리사이즈 이벤트 핸들러 =====
    const handleResize = () => {
      const newCanvasWidth = (29.04 * window.innerWidth) / 100;
      const newCanvasHeight = (27.47 * window.innerWidth) / 100;
  ...
  // ===== JSX 렌더링 =====
  return <div ref={mountRef} style={{ width: "29.04vw", height: "27.47vw" }} />;
};

export default Object3D_two;